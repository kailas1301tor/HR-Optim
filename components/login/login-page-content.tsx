        ...
        <motion.div variants={itemVariants}>
          <div className={cn(uiCard, 'bg-card/45 backdrop-blur-md shadow-2xl shadow-black/40 p-6 sm:p-8')}>
            <div className="pb-4">
              ...
              <p className="text-xs text-muted-foreground mt-0.5 font-sans">Please sign in to access your dashboard</p>
            </div>
            <div>
              {formError && <CommonErrorBanner message={formError} className="mb-4" />}
              <FormProvider {...methods}>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="username-input" className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <Input
                        ...
                        className={cn(
                          uiInput,
                          'pl-10 min-h-11 text-cloud focus-visible:ring-primary/30',
                          errors.username && 'border-destructive focus-visible:border-destructive'
                        )}
                      />
                    </div>
                    <CommonFormFieldError message={errors.username?.message} />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="password-input" className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                      Password
                    </Label>
                    <div className="relative flex items-center">
                      ...
                      <Input
                        ...
                        className={cn(
                          uiInput,
                          'pl-10 pr-10 min-h-11 text-cloud focus-visible:ring-primary/30',
